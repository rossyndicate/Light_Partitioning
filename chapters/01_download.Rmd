...
available. We start out using the following parameters and parameter
...
Portal. Florida is mapped separately because of its high concentration
of values. **Note:** 1) the top four grid cells in the FL map are
included in both maps, 2) the counts here are for raw data that are not
filtered for simultaneous records.
...
![](/Users/mbrousil/Documents/Light_Partitioning/chapters/01_download_files/figure-gfm/unnamed-chunk-2-1.png)<!-- -->
...
![](/Users/mbrousil/Documents/Light_Partitioning/chapters/01_download_files/figure-gfm/unnamed-chunk-2-2.png)<!-- -->
